...
export CUDA_VISIBLE_DEVICES=1 CUDA_DEVICE_ORDER=PCI_BUS_ID VLLM_SKIP_WARMUP=1 VLLM_USE_DEEP_GEMM=0
vllm serve models/qwythos_src --served-model-name qwythos \
